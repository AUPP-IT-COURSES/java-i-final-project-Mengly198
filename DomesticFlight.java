...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		LBookingDetails = new JLabel("<html><b><font size = '+1' color=\"#C71585\">Booking Details</font></b></html>");
		...
		LBookingDetails.setBounds(40,40,300,25);

		LFrom.setBounds(40,80,100,20);
		CBFrom.setBounds(130,80,100,20);

		LTo.setBounds(40,120,100,20);
		CBTo.setBounds(130,120,100,20);

		LBookingDate.setBounds(40,160,100,20);
		TFBookingDate.setBounds(130,160,100,20);
		LDate.setBounds(250,160,100,20);

		LClass.setBounds(40,200,100,20);
		CBClass.setBounds(130,200,100,20);

		BFindFlight.setBounds(200,270,100,25);
		...
		LPassengerDetails =new JLabel("<html><b><font color=\"#C71585\" size = '+1'>Passenger Details</font></b></html>");
		...
		LNotes = new JLabel("<html><body><p>NOTE:   Please read carefully and make <p> sure your information  is correct. There will <p> be no refunds for incorrect booking flights.<p>  Therefore, please be cautious.</body></html>");

		LPassengerDetails.setBounds(40,40,300,25);

		LAdult.setBounds(40,70,100,20);
		CBAdult.setBounds(140,70,100,20);

		LChildren.setBounds(40,105,100,20);
		CBChildren.setBounds(140,105,100,20);

		LInfant.setBounds(40,140,100,20);
		CBInfant.setBounds(140,140,100,20);

		LImg2.setBounds(22,220,320,200);
